...
\begin{frame}{What is studied?}
    \begin{columns}
        \column{0.6\textwidth}
            ...
            \begin{figure}
                \centering
                \resizebox{!}{5.3cm}{\input{Images/HDT}}
...
\begin{frame}{Hybrid Distribution Transformer}
    \begin{figure}
        \centering
        \resizebox{!}{5.5cm}{\input{Images/HDT_Schematic.tex}}
        \caption{HDT Schematic.}
        \label{fig:HDT_Schematic}
    \end{figure}
\end{frame}
...
\begin{frame}{Hybrid Distribution Transformer}
    \begin{figure}
        \centering
        \resizebox{!}{5.5cm}{\input{Images/HDT_Control.tex}}
        \caption{HDT Control Scheme.}
        \label{fig:HDT_Control}
    \end{figure}
\end{frame}

\begin{frame}{HDT as an Interlinking Converter}
        \begin{itemize}
            \item<1-2> The HDT issue of circulating active power flow (CAPF) can be eliminated if a DC microgrid (DC-MG) is connected to the DC-Link of both voltage and current converters.
            \item<1-2> This enables the HDT to act as an interlinking converter (IC) between these two MGs.
        \end{itemize}
        \only<2>{
        \begin{exampleblock}{Observations}
            \begin{itemize}
...
\begin{frame}{HDT as an Interlinking Converter}
    \begin{figure}
        \centering
        \resizebox{!}{6.3cm}{\input{Images/HybridMG.tex}}
        \caption{Hybrid microgrid with the HDT as an interlinking converter.}
        \label{fig:HybridMG}
    \end{figure}
\end{frame}
    ...
    \begin{columns}
        ...
        \column{0.5\textwidth}
            \begin{figure}
                ...
                \only<3>{\input{Images/HierarchicalMG-TC}}
                }
...
\begin{frame}{HDTs as a Promising Solution for AC and DC Microgrids Integration}
    \begin{figure}
        \centering
        \resizebox{!}{5.3cm}{\input{Images/ACDCMicrogrid_InterlinkingHDT}}
