...
\begin{frame}{Reseach Interests}
    \begin{itemize}
        \item Power electronics
        \item Control theory
        \item Renewable energy systems
        \item Microgrids
        \item Power management of microgrids
    \end{itemize}
\end{frame}
...
\begin{frame}{Master's Thesis Topic}
    \begin{columns}
        \column{0.5\textwidth}
            ...
            \begin{itemize}
                \item The goal was to achieve a primary control loop for an AC microgrid, capable of enforcing system constraints using MPC.
            \end{itemize}
        \column{0.5\textwidth}
            \begin{figure}
                \centering
...
\begin{frame}{Problem of Interest}
    \begin{figure}
        \centering
        \resizebox{!}{4cm}{\input{Images/ACMicrogrid}}
...
\begin{frame}{Problem of Interest (continued)}
    \begin{figure}
        \centering
        \resizebox{!}{4cm}{\input{Images/DCMicrogrid}}
...
\begin{frame}{Problem of Interest: Integration of AC and DC Microgrids}
    \begin{figure}
        \centering
        \resizebox{!}{5.3cm}{\input{Images/ACDCMicrogrid_InterlinkingConverter}}
...
\begin{frame}{Solid-State Transformers}
    \begin{columns}
        \column{0.4\textwidth}
            \begin{figure}
                \centering
                \resizebox{!}{1.7cm}{\input{Images/SST}}
        ...
        \column{0.6\textwidth}
            ...
            \begin{itemize}
                \item These devices are based either an AC-AC converter or a AC-DC/DC-AC converter with a active rectifier for the DC stage.
            \end{itemize}
